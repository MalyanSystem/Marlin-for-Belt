...
#define SERIAL_ECHOLN(x)        SERIAL_OUT(println, x);vTaskDelay(1 / portTICK_PERIOD_MS)
#define SERIAL_PRINT(x,b)       SERIAL_OUT(print, x, b)
#define SERIAL_PRINTLN(x,b)     SERIAL_OUT(println, x, b);vTaskDelay(1 / portTICK_PERIOD_MS)
...
#define SERIAL_FLUSH()          SERIAL_OUT(flush)
  ...
  #define SERIAL_FLUSHTX()      SERIAL_OUT(flush)//flushTX
#else
