...
// Defines
// ------------------------
extern portMUX_TYPE hal_spinlock;
...
#else
  #define NUM_SERIAL 2
  #define MYSERIAL0 USBSerial//flushableSerial
  #define MYSERIAL1 Serial//USBSerial or Serial1
#endif

#define CRITICAL_SECTION_START() portENTER_CRITICAL(&hal_spinlock)
#define CRITICAL_SECTION_END()   portEXIT_CRITICAL(&hal_spinlock)
//#define ISRS_ENABLED() (hal_spinlock.spinlock.owner == portMUX_FREE_VAL)
#define ENABLE_ISRS()  /*if (hal_spinlock.spinlock.owner != portMUX_FREE_VAL)*/ portEXIT_CRITICAL(&hal_spinlock)
#define DISABLE_ISRS() portENTER_CRITICAL(&hal_spinlock)
