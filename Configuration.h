...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MALYAN_ESP32
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 92, 92, 1097, 97 }
...
#elif defined MA10 || defined MA10mini
...
#define Z_PROBE_SPEED_SLOW (100)//(Z_PROBE_SPEED_FAST / 2)
...
#define INVERT_X_DIR (invert_byte & 0x1)//false
#define INVERT_Y_DIR (invert_byte & 0x2)//true
#define INVERT_Z_DIR (invert_byte & 0x4)//false

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR (invert_byte & 0x08)//false
#define INVERT_E1_DIR (invert_byte & 0x10)//false
...
#ifdef MA10
#define HOMING_FEEDRATE_Z  (4*105)
#else
#define HOMING_FEEDRATE_Z  (8*90)
#endif
