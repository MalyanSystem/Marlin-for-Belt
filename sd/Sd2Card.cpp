...
//extern "C" esp_err_t IRAM_ATTR esp_backtrace_print(int depth);
extern bool USBreadBlock(uint32_t blockNumber, uint8_t* dst);
/**
...
bool Sd2Card::readBlock(uint32_t blockNumber, uint8_t* dst) {
  //hzw
  //Serial1.printf("{X:%d}",blockNumber);
  return USBreadBlock(blockNumber,dst);
