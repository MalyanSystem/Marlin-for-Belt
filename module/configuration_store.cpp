...
void MarlinSettings::reset() {
  ...
  invert_byte = DEFAULT_AXIS_DIRECTION;
  ...
  void MarlinSettings::report(const bool forReplay) {
     ...
     */
    CONFIG_ECHO_START();vTaskDelay(10);
    #if ENABLED(INCH_MODE_SUPPORT)
      SERIAL_ECHOPGM("  G2");
