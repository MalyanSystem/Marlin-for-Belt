 ...
 */
void IRAM_ATTR Stepper::set_directions() {
 ...
 */
void IRAM_ATTR Stepper::pulse_phase_isr() {
...
uint32_t IRAM_ATTR Stepper::block_phase_isr() {
 ...
 */
void IRAM_ATTR Stepper::_set_position(const int32_t &a, const int32_t &b, const int32_t &c, const int32_t &e) {
  #if CORE_IS_XY
    // corexy positioning
