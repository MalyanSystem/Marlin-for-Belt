...
#include "../../../../../inc/MarlinConfigPre.h"
  ...
  uint8_t ExtUI::StandardCharSet::std_char_width(char c) {
  ...
  void ExtUI::StandardCharSet::load_data(uint32_t) {
  }
  ...
  void ExtUI::StandardCharSet::load_bitmaps() {
    FontMetrics std_fm(std_font);
    set_font_bitmap(std_fm, std_font);
  }
  ...
  bool ExtUI::StandardCharSet::render_glyph(int &x, int &y, font_size_t fs, utf8_char_t c) {
    ...
    // Draw the character
    //if (cmd) ext_vertex2ii(x, y, std_font, which);
    printf("ExtUI::StandardCharSet::render_glyph\n");
