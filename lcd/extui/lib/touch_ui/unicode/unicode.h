...
void draw_utf8_text(int x, int y, progmem_str, font_size_t, uint16_t options = 0);
void draw_utf8_text(int x, int y, const char *, font_size_t, uint16_t options = 0);

// Similar to FontMetrics, but can be used with UTF8 encoded strings.
/*
struct FontMetrics {
  #ifdef TOUCH_UI_USE_UTF8
    font_size_t fs;
