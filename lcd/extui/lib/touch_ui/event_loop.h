...
#define TOUCH_UPDATE_INTERVAL       100
...
class EventLoop {
  private:
    static constexpr effect_t press_sound   = CHACK;
    static constexpr effect_t repeat_sound  = CHACK;
    static constexpr effect_t unpress_sound = POP;
